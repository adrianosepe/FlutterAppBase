import 'dart:async';
import 'package:app_base/events/delegates.dart' as delegates;
import 'package:app_base/events/event_args.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class AsyncButton<TData> extends StatefulWidget {
	final ActionCancelEventHandler<TData> onExecute;
	final delegates.Act1<TData> onSuccess;
	final delegates.Act1<TData> onFail;
	final Widget child;
	final Color color;
	final Color textColor;

	AsyncButton({Key key, @required this.onExecute, this.onSuccess, this.onFail, this.child, this.color, this.textColor})
			: super(key: key);
