...
class _DatePickerHeader extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		headerTextTheme.display1.copyWith(color: dayColor, height: 1.4); // ignore: deprecated_member_use
		final TextStyle yearStyle =
		headerTextTheme.subhead.copyWith(color: yearColor, height: 1.4); // ignore: deprecated_member_use
			...
			return IgnorePointer(
				...
				child: _DateHeaderButton(
					...
					child: Semantics(
							...
							child:
							Text(localizations.formatYear(date), style: yearStyle)),
				),
			);
		}
		...
		for (int i = 0; true; i += 1) {
			...
			if (day < 1) {
				...
				if (isSelectedFirstDay &&
					...
					itemStyle =
							themeData.textTheme.body1.copyWith(color: themeData.disabledColor); // ignore: deprecated_member_use
					...
					child: Center(
						child: Semantics(
							...
							child: ExcludeSemantics(
								...
								Container(
									decoration: BoxDecoration(
											border: Border.all(color: Colors.green, width: 4), shape: BoxShape.circle),
									child: Center(
			...
			itemBuilder: (BuildContext context, int index) {
				...
				return InkWell(
					...
					onTap: () {
						...
						if (widget.selectedLastDate == null) {
							DateTime newDate = DateTime(year,
