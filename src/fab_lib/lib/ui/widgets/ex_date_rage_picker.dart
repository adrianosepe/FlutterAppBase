...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle = headerTextTheme.display1.copyWith(color: dayColor, height: 1.4); // ignore: deprecated_member_use
    final TextStyle yearStyle = headerTextTheme.subhead.copyWith(color: yearColor, height: 1.4); // ignore: deprecated_member_use
    ...
    Widget renderYearButton(date) {
      return IgnorePointer(
        ...
        child: _DateHeaderButton(
          ...
          child: Semantics(selected: mode == DatePickerMode.year, child: Text(localizations.formatYear(date), style: yearStyle)),
        ),
      );
    }
...
class DayPicker extends StatelessWidget {
  ...
  DayPicker({
    ...
    this.dayHasEventPredicate,
  })  : assert(selectedFirstDate != null),
        assert(currentDate != null),
        assert(onChanged != null),
        assert(displayedMonth != null),
        assert(!firstDate.isAfter(lastDate)),
        assert(!selectedFirstDate.isBefore(firstDate) && (selectedLastDate == null || !selectedLastDate.isAfter(lastDate))),
  ...
  final SelectableDayPredicate dayHasEventPredicate;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        final hasEvent = !disabled && (dayHasEventPredicate(dayToBuild));

        BoxDecoration decoration;
        TextStyle itemStyle = themeData.textTheme.body1; // ignore: deprecated_member_use
        final bool isSelectedFirstDay = selectedFirstDate.year == year && selectedFirstDate.month == month && selectedFirstDate.day == day;
        final bool isSelectedLastDay =
            selectedLastDate != null ? (selectedLastDate.year == year && selectedLastDate.month == month && selectedLastDate.day == day) : null;
        final bool isInRange = selectedLastDate != null ? (dayToBuild.isBefore(selectedLastDate) && dayToBuild.isAfter(selectedFirstDate)) : null;

        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          itemStyle = themeData.accentTextTheme.body2; // ignore: deprecated_member_use
          decoration = BoxDecoration(color: themeData.accentColor, shape: BoxShape.circle);
          ...
          decoration = BoxDecoration(color: themeData.accentColor.withOpacity(0.1), shape: BoxShape.rectangle);
        } else if (disabled) {
          itemStyle = themeData.textTheme.body1.copyWith(color: themeData.disabledColor); // ignore: deprecated_member_use
        } else if (currentDate.year == year && currentDate.month == month && currentDate.day == day) {
          // The current day gets a different text color.
          itemStyle = themeData.textTheme.body2.copyWith(color: themeData.accentColor); // ignore: deprecated_member_use
        }

        if (hasEvent) {
          itemStyle = itemStyle.copyWith(fontWeight: FontWeight.bold);
        }
          ...
          child: Center(
            child: Semantics(
              ...
              child: ExcludeSemantics(
                child: hasEvent
                    ? Container(
                        decoration: BoxDecoration(border: Border.all(color: Colors.green, width: 4), shape: BoxShape.circle),
                        child: Center(
            ...
            child: Center(
              child: ExcludeSemantics(
                child: Text(
                  ...
                  style: themeData.textTheme.subhead, // ignore: deprecated_member_use
                ),
              ),
            ),
          ),
...
class _MonthPickerState extends State<MonthPicker> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _chevronOpacityController = AnimationController(duration: const Duration(milliseconds: 250), vsync: this);
    _chevronOpacityAnimation = Tween<double>(begin: 1.0, end: 0.0).animate(CurvedAnimation(
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    return DayPicker(
      ...
      dayHasEventPredicate: widget.dayHasEventPredicate,
    );
  }
            ...
            child: NotificationListener<ScrollStartNotification>(
              ...
              child: NotificationListener<ScrollEndNotification>(
                ...
                child: PageView.builder(
                  key: ValueKey<DateTime>(widget.selectedFirstDate == null ? widget.selectedFirstDate : widget.selectedLastDate),
              ...
              child: FadeTransition(
                ...
                child: _isDisplayingFirstMonth
                    ...
                    : IconButton(
                        ...
                        tooltip: '${localizations.previousMonthTooltip} ${localizations.formatMonthYear(_previousMonthDate)}',
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData themeData = Theme.of(context);
    final TextStyle style = themeData.textTheme.body1; // ignore: deprecated_member_use
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final bool isSelected = year == widget.selectedFirstDate.year || (widget.selectedLastDate != null && year == widget.selectedLastDate.year);
        final TextStyle itemStyle = isSelected
            ? themeData.textTheme.headline.copyWith(color: themeData.accentColor) // ignore: deprecated_member_use
            : style;
        return InkWell(
          ...
          onTap: () {
            ...
            if (widget.selectedLastDate == null) {
              DateTime newDate = DateTime(year, widget.selectedFirstDate.month, widget.selectedFirstDate.day);
              changes = [newDate, newDate];
            } else {
              changes = [DateTime(year, widget.selectedFirstDate.month, widget.selectedFirstDate.day), null];
            }
  ...
  void _handleModeChanged(DatePickerMode mode) {
    ...
    setState(() {
      ...
      if (_mode == DatePickerMode.day) {
        ...
        if (_selectedLastDate != null) {
          SemanticsService.announce(localizations.formatMonthYear(_selectedLastDate), textDirection);
        }
      } else {
...
///  * [showTimePicker]
///  * <https://material.google.com/components/pickers.html#pickers-date-pickers>
Future<List<DateTime>> showDateRangerPicker({
  ...
  SelectableDayPredicate dayHasEventPredicate,
  ...
  assert(selectableDayPredicate == null || selectableDayPredicate(initialFirstDate) || selectableDayPredicate(initialLastDate),
  ...
  Widget child = _DatePickerDialog(
    ...
    lastDate: lastDate,
    selectableDayPredicate: selectableDayPredicate,
    dayHasEventPredicate: dayHasEventPredicate,
